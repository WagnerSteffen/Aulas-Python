...
def main():
    ...
    ogre = player("Ogre", 30, 5, 100, 5)
    goblin = player("Goblin", 15, 10, 70, 10)
    eskeleton = player("Eskeleton", 10, 20, 90, 20)
    witch = player("Witch", 10, 30, 80, 20)
    enemies = [ogre, goblin, eskeleton, witch]
